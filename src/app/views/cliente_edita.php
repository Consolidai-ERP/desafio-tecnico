                ...
                <form id="formEditaCliente" method="POST">
                    ...
                    <div class="row mb-3">
                        <div class="col-12 col-md-2">
                            ...
                            <input type="text" class="form-control" id="cep" name="cep" pattern="\d{5}-\d{3}" maxlength="9" value="<?php echo htmlspecialchars($cliente['cep']); ?>" required>
                        </div>
                        <div class="col-12 col-md-6">
                        ...
                        <div class="col-12 col-md-2">
                            ...
                            <input type="text" class="form-control" id="numero" name="numero" value="<?= htmlspecialchars($cliente['numero']); ?>" required>
                        </div>
                        <div class="col-12 col-md-2">
                            <label for="complemento" class="form-label">Complemento</label>
                            <input type="text" class="form-control" id="complemento" name="complemento" value="<?= htmlspecialchars($cliente['complemento']); ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-12 col-md-3" id="cpf-content">
                            ...
                            <input type="text" class="form-control" id="cpf" value="<?= htmlspecialchars($cliente['cpf_cnpj']); ?>" name="cpf" maxlength="14" disabled>
                            <p id="alertCpf" class="text-danger d-none">CPF inválido</p>
                        </div>

                        <div class="col-12 col-md-3 d-none" id="cnpj-content">
                            <label for="cnpj" class="form-label">CNPJ</label>
                            <input type="text" class="form-control" id="cnpj" value="<?= htmlspecialchars($cliente['cpf_cnpj']); ?>" name="cnpj" maxlength="18" disabled>
